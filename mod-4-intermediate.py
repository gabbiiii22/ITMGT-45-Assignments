...
def shift_letter(letter, shift):
    ...
    *Note: the single underscore `_` is used to acknowledge the presence
    ...
    shift = int(input("How many times do you want to shift this letter by? "))
...
def caesar_cipher(message, shift):
    ...
    shift = int(input("How many times do you want to shift your message by? "))
...
def shift_by_letter(letter, letter_shift):
    ...
    #new input
    letter = input("What letter do you want to shift? ")
    letter_shift = input("By what letter do you want to shift the first letter by? ")
